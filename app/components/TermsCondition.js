...
export default function TermsAndConditions(props) {
    ...
    const[accepted,setAccrpted] = useState(false);
...
Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</Text>
            ...
            <TouchableOpacity disabled={ !accepted } onPress={props.closeTerms} style={ accepted ? styles.button : styles.buttonDisabled }><Text style={styles.buttonLabel}>Accept</Text></TouchableOpacity>
      </View>
      </Modal>
    );
